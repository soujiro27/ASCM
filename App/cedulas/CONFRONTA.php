...
con.*, catsub.idTipoDocto as tipo
from sia_Volantes v
...
<table cellspacing="0" cellpadding="0" border="0">
    <tr>
        ...
        <td width="323"><p style="text-align:justify"><b>DIRECCIÓN GENERAL DE ASUNTOS JURÍDICOS<br><br>NOTA INFORMATIVA</b><br><br>Ciudad de México, '. $fecha[2] . ' de ' .$mes . ' de ' . $fecha[0].'.'.'<br><br><i>"Fiscalizar con Integridad para Prevenir y Mejorar".</i></p></td>
    </tr>
</table>';
$pdf->SetFont('helvetica', '', 11);
$pdf->writeHTML($text1);
...
$titular = $confronta[0]['nombreRemitente'];
$area = $confronta[0]['puestoRemitente'];
...
<table cellspacing="0" cellpadding="1" border="0" >
    <tr >
        ...
        <td style="text-align:right"><br>Ref. $refDocumento</td>
    </tr>
</table>
EOD;
