...
$sql_area = "select a.* from sia_areas a 
...
<table cellspacing="0" cellpadding="0" border="0">
    <tr>
        <td width="264"><img src="img/logo-top.png"/></td>
        <td width="323"><p><b>DIRECCIÓN GENERAL DE ASUNTOS JURÍDICOS<br><br>NOTA INFORMATIVA</b><br><br>Ciudad de México,'. $fecha[2] . ' de ' .$mes . ' de ' . $fecha[0].'.'.'<br><br><i>"Fiscalizar con Integridad para Prevenir y Mejorar".</i></p></td>
    </tr>
</table><p></p>';
}
